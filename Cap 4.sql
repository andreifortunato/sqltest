...
-- Round e Trunc
SELECT Round(45.925, 2 ),  --45.93 ARREDONDA O NUMERO PARA CIMA
       Trunc(45.929, 2 ),  --45.92 ARREDONDA O NUMERO PARA BAIXO
       Mod(10, 2) AS RESTO_DIVISAO, -- MOSTRA O RESTA DA DIVISÃO
       Trunc(1.99),
       Trunc(1.99, 2)
FROM DUAL;
